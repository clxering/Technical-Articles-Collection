...
## Array vs ArrayList in Java（Java 中的数组与 ArrayList）
...
### 9、Size() vs length（Size() 方法与 length 属性）
...
## Difference between array vs ArrayList in Java（Java 中数组与 ArrayList 的区别）
